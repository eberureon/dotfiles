# Generated by Powerlevel10k configuration wizard on 2025-03-25 at 10:34 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49778.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, blurred heads, flat tails, 1 line, compact, many icons,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 48 long, show it in full.
      # Otherwise show the first 24 … the last 24.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 48 )) && branch[24,-24]="…"  # <-- this line
