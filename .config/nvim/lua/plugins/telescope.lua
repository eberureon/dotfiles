...
return {
  ...
  config = function()
    ...
    vim.api.nvim_create_user_command('LiveGrepWithArgs',
      ':lua require("telescope").extensions.live_grep_args.live_grep_args()', {})

    vim.keymap.set('n', '<leader>s/', telescope_live_grep_open_files, { desc = '[S]earch [/] in Open Files' })
    vim.keymap.set('n', '<leader>ss', require('telescope.builtin').builtin, { desc = '[S]earch [S]elect Telescope' })
    vim.keymap.set('n', '<leader>gf', builtin.git_files, { desc = 'Search [G]it [F]iles' })
    vim.keymap.set('n', '<leader>gc', builtin.git_status, { desc = 'Search changed [G]it [F]iles' })
    vim.keymap.set('n', '<leader>gg', ':LiveGrepGitRoot<cr>', { desc = 'Search [G]it by [G]rep' })
